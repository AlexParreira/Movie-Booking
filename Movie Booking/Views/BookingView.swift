        ...
        NavigationView{
            ZStack{
                ...
                VStack (spacing: 0.0){
                    ...
                    Text("Dr. Stephen Strange casts a forbidden spell than opens the doorway to the multiverse, including alternate versions of ...")
                        .font(.subheadline)
                        .foregroundColor(.white)
                        .padding(30)
                    ...
                    HStack(alignment: .top,spacing: 20.0){
                        ...
                        DateButton(weekDay: "man", numDay: "25", isSelected: $bindingSelection)
                            .padding(.top, 90)
                    }
                    
                    HStack(alignment: .top, spacing: 20){
                        TimeButton(hour: "14:00", isSelected: $bindingSelection)
                            .padding(.top, 20)
                        
                        TimeButton(hour: "16:00", isSelected: $bindingSelection)
                            
                        
                        TimeButton(hour: "18:00",width: 70 ,height: 40 ,isSelected: $selectHour, action:  {
                            withAnimation(.spring()){
                                selectHour.toggle()
                            }
                        })
                        ...
                        TimeButton(hour: "22:00", isSelected: $bindingSelection)
                            .padding(.top, 20)
                    }
                    NavigationLink{
                        Text("Seat View")
                        ...
                        LargeButton()
                            .padding(20)
                            .offset(y: selectedDate && selectHour ? 0 : 200)
                    }
                }
                .frame(maxHeight: .infinity, alignment: .top)
            }
